<template>
  <div class="container" :class="{'light-background':!isDarkMode,'dark-background':isDarkMode}">
    ...
    >Don't have a Bolt account?
      <router-link to="/request">Request an account</router-link>
    </div>
    <div class="login">
      <img src="@/assets/Bolt_logo.png" width="100px" height="100px" v-if="isDarkMode">
      <img src="@/assets/Bolt_logo.png" width="100px" height="100px" v-if="!isDarkMode">
      <h4 :class="{'light-text':!isDarkMode , 'dark-text':isDarkMode}">Sign into Bolt Studio</h4>
      <input
        type="email"
        placeholder="Email"
